...
/*global define*/
define(
    [ 'react','script-utils', 'model/Comment' ],
    function ( React, ScriptUtils, Comment ) {
      ...
      CommentForm = React.createClass( {
        ...
        clearState: function () {
          ...
          this.setState( { visible: false, model: new Comment() } );
        },

        getInitialState: function () {
          this.log( "Getting initial State" );
          return { visible: false, model: new Comment() };
        },
          ...
          if ( this.state.visible ) {
            ...
            return (
                <form className="commentForm" onSubmit={this.handleOnSubmit}>
                  <input type="text" name="author" value={author} onChange={this.handleOnChange} placeholder="Votre nom" required />
                  <input type="text" name="title" value={title} onChange={this.handleOnChange} className="comment-title" placeholder="Votre titre" required />
                  <textarea name="comment" value={comment} onChange={this.handleOnChange} placeholder="Votre commentaire..." required />
                  <input type="submit" className="btn btn-envoyer" value="Envoyer" />
                </form>
                );
          }
          else {
            return (
                <button className="btn btn-plus" onClick={this.handlePlusOnClick}>Commenter...</button>
                );
          }
        }
      } );

          ...
          if ( this.state.visible ) {
            ...
            return (
                React.DOM.form( {className:"commentForm", onSubmit:this.handleOnSubmit}, 
                  React.DOM.input( {type:"text", name:"author", value:this.state.author, onChange:this.handleOnChange, placeholder:"Votre nom", ref:"author"}),
                  React.DOM.input( {type:"text", name:"title", value:this.state.title, onChange:this.handleOnChange, className:"comment-title", placeholder:"Votre titre", ref:"title"}),
                  React.DOM.textarea( {name:"comment", value:this.state.comment, onChange:this.handleOnChange, placeholder:"Votre commentaire...", ref:"comment"} ),

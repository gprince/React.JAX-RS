          ...
          if ( this.state.visible ) {
            ...
            return (
                React.DOM.form( {className:"commentForm", onSubmit:this.handleOnSubmit}, 
                  React.DOM.input( {type:"text", name:"author", value:author, onChange:this.handleOnChange, placeholder:"Votre nom", required:true} ),
                  React.DOM.input( {type:"text", name:"title", value:title, onChange:this.handleOnChange, className:"comment-title", placeholder:"Votre titre", required:true} ),
                  React.DOM.textarea( {name:"comment", value:comment, onChange:this.handleOnChange, placeholder:"Votre commentaire...", required:true} ),
